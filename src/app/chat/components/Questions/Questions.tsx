...
const Questions = ({ questions, handleClick }: QuestionsProps) => {
  ...
  return (
    <div className="@container relative flex h-[13.1rem] w-full max-w-[76.4rem] justify-center tablet:max-w-[min(calc(100vw-60px),76.4rem)]">
      <div
        className={clsx(
          'pointer-events-none absolute top-0 z-10 flex size-full max-w-[76.4rem] items-center justify-between px-[4rem]',
          isSmall &&
