  ...
  return (
    <div className="flex size-full flex-col items-center justify-between gap-[0.8rem]">
      <div className="flex flex-col items-center justify-center gap-[1.6rem]">
        ...
        <h2 className="whitespace-pre-wrap text-center text-body-1-medium">{`간단한 퀴즈를 풀면서 블록체인 지식을 쌓고\n실력을 측정해 보아요!`}</h2>
      </div>
      <Image src="/images/chat/block.gif" alt="block" width={300} height={300} className="scale-120" />
      <button
