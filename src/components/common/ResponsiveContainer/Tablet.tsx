...
export default function Tablet({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex">
      <aside className="flex h-[100vh] w-[60px] flex-col items-center pb-[20px] pt-[20px]">
...
const ThemeSwitch = () => {
  ...
  return (
    ...
    >
      <Icon
        name={isLightMode ? "LightMode" : "DarkMode"}
        className={isLightMode ? "fill-gray-900" : "fill-gray-500"}
      />
    </button>
  );
};
